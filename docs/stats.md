...
<p class="text-muted">Includes players with 2+ games. {{ excluded_count }} player{% if excluded_count != 1 %}s{% endif %} not shown. Ranked by wins, then top ⅓%, then average score.</p>
